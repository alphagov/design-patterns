  ...
  <div class="grid">
    <div class="inner-block example-typography">
      ...
      <div class="text">
        ...
        <div class="heading-36">A 36px heading <em class="highlight">.heading-36</em></div>
        ...
        <div class="heading-24">A 24px heading <em class="highlight">.heading-24</em></div>
        ...
        <div class="heading-19">A 19px heading <em class="highlight">.heading-19</em></div>
